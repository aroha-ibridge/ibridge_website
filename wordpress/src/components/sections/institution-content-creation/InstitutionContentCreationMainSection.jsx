...
function InstitutionContentCreationMainSection() {
  return (
    <>
      <section data-particle_enable="false" data-particle-mobile-disabled="false" className="elementor-section elementor-top-section elementor-element elementor-element-8522b38 elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-id="8522b38" data-element_type="section" id="mainbody">
      			...
      			<Link to="/institution" className="elementor-button elementor-button-link elementor-size-sm" >
      				...
      				<svg aria-hidden="true" className="e-font-icon-svg e-fas-angle-right" viewBox="0 0 256 512" xmlns="http://www.w3.org/2000/svg"><path d="M224.3 273l-136 136c-9.4 9.4-24.6 9.4-33.9 0l-22.6-22.6c-9.4-9.4-9.4-24.6 0-33.9l96.4-96.4-96.4-96.4c-9.4-9.4-9.4-24.6 0-33.9L54.3 103c9.4-9.4 24.6-9.4 33.9 0l136 136c9.5 9.4 9.5 24.6.1 34z"></path></svg>			</span>
      									<span className="elementor-button-text">Institution</span>
      					</span>
      					</Link>
      		</div>
      				</div>
      			...
      			<h2 className="elementor-heading-title elementor-size-default">Overview</h2>		</div>
      				...
      				<div className="elementor-widget-container">
      							<p>In today’s competitive landscape, prospective students and parents judge your institution by its digital first impression. iBridge360 helps you move beyond generic brochures. We craft compelling narratives that showcase your unique culture, academic excellence, and student success stories. We help you cut through the noise to attract qualified applicants, boost enrollment yields, and build a community that students are proud to join.</p>						</div>
      				</div>
      			...
      			<div className="elementor-widget-wrap elementor-element-populated">
      				...
      				<div className="elementor-widget-container">
      			<h2 className="elementor-heading-title elementor-size-default">Boost your brand's visibility and connect with your audience through iBridge360's Content Creation Services. With a focus on quality and personalized solutions, we ensure your content not only reaches but deeply engages your target market.</h2>		</div>
      				</div>
      					</div>
      		</div>
      			...
      			<div className="elementor-widget-wrap elementor-element-populated">
      				...
      				<div className="elementor-widget-container">
      			<div className="elementor-image-box-wrapper"><figure className="elementor-image-box-img"><img decoding="async" width="175" height="152" src="/wp-content/uploads/2024/12/Content-Creation-Services-1.png" className="attachment-full size-full wp-image-19997" alt="" /></figure><div className="elementor-image-box-content"><h3 className="elementor-image-box-title">Blog Posts and Articles</h3><p className="elementor-image-box-description">We craft SEO-friendly articles that directly answer the questions students and parents search online. With smart keyword use and engaging storytelling, we help your institution rank higher, attract organic traffic to program pages, and stand out as the top choice for education</p></div></div>		</div>
      				</div>
      				...
      				<div className="elementor-widget-container">
      			<div className="elementor-image-box-wrapper"><figure className="elementor-image-box-img"><img decoding="async" width="175" height="152" src="/wp-content/uploads/2024/12/Content-Creation-Services-3.png" className="attachment-full size-full wp-image-19993" alt="" /></figure><div className="elementor-image-box-content"><h3 className="elementor-image-box-title">Website Content</h3><p className="elementor-image-box-description">Could your website be driving students away? We turn complex language into clear, persuasive messaging that guides students and parents smoothly from exploring to applying—keeping your admissions pipeline always open</p></div></div>		</div>
      				</div>
      				...
      				<div className="elementor-widget-container">
      			<div className="elementor-image-box-wrapper"><figure className="elementor-image-box-img"><img decoding="async" width="175" height="152" src="/wp-content/uploads/2024/12/Content-Creation-Services-2.png" className="attachment-full size-full wp-image-19992" alt="" /></figure><div className="elementor-image-box-content"><h3 className="elementor-image-box-title">Social Media Content</h3><p className="elementor-image-box-description">Your audience is everywhere—students on TikTok, parents on Facebook, donors on LinkedIn. We move beyond one-size-fits-all content by tailoring messaging for each platform. The result: trust with parents, excitement with applicants, and maximum reach across every channel</p></div></div>		</div>
      				</div>
      					</div>
      		</div>
      			...
      			<div className="elementor-widget-wrap elementor-element-populated">
      				...
      				<div className="elementor-widget-container">
      			<div className="elementor-image-box-wrapper"><figure className="elementor-image-box-img"><img loading="lazy" decoding="async" width="175" height="152" src="/wp-content/uploads/2024/12/Content-Creation-Services-5.png" className="attachment-full size-full wp-image-19995" alt="" /></figure><div className="elementor-image-box-content"><h3 className="elementor-image-box-title">Video Production</h3><p className="elementor-image-box-description">Bring your campus to their screens.
      Students often decide based on a feeling, and we help you create it. With engaging video tours and lively campus reels, they can experience your culture from anywhere. Don’t let distance stop them—show them why your institution is the right fit
      </p></div></div>		</div>
      				</div>
      				...
      				<div className="elementor-widget-container">
      			<div className="elementor-image-box-wrapper"><figure className="elementor-image-box-img"><img loading="lazy" decoding="async" width="175" height="152" src="/wp-content/uploads/2024/12/Content-Creation-Services-4.png" className="attachment-full size-full wp-image-19994" alt="" /></figure><div className="elementor-image-box-content"><h3 className="elementor-image-box-title">Infographics and Visual Content</h3><p className="elementor-image-box-description">Complex text can overwhelm prospective students. We turn course details and research into eye-catching infographics that instantly capture attention. At a glance, your audience sees the value of your programs and the opportunities ahead</p></div></div>		</div>
      				</div>
      				...
      				<div className="elementor-widget-container">
      			<div className="elementor-image-box-wrapper"><figure className="elementor-image-box-img"><img loading="lazy" decoding="async" width="175" height="152" src="/wp-content/uploads/2024/12/Content-Creation-Services-6.png" className="attachment-full size-full wp-image-19996" alt="" /></figure><div className="elementor-image-box-content"><h3 className="elementor-image-box-title">E-books and Whitepapers</h3><p className="elementor-image-box-description">Claiming expertise isn’t enough—you need to show it. We turn faculty insights and research into professional whitepapers that speak the language of business, showcasing your institution’s impact to partners, donors, and grant committees while opening doors to new opportunities</p></div></div>		</div>
      				</div>
      					</div>
      		</div>
      					</div>
...
export default InstitutionContentCreationMainSection;
