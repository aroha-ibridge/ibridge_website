...
const PROGRAM_LINKS = [
  ...
  { label: 'PySpark', to: '/programs#pyspark' },
  { label: 'Databricks Data Engineering', to: '/programs#databricks-data-engineering' },
  { label: 'Microsoft Fabric Data Engineering', to: '/programs#microsoft-fabric-data-engineering' },
  { label: 'Tableau', to: '/programs#tableau' },
  { label: 'Advanced Excel', to: '/programs#advanced-excel' },
  { label: 'SQL Bootcamp', to: '/programs#sql-bootcamp' },
  { label: 'Python Bootcamp', to: '/programs#python-bootcamp' },
  { label: 'Data Science', to: '/programs#data-science' },
  { label: 'Java Full Stack', to: '/programs#java-fullstack' },
  { label: 'Python Full Stack', to: '/programs#python-fullstack' },
  { label: 'MERN Full Stack', to: '/programs#full-stack-mern' },
