...
const sourceHtml = path.resolve(
  root,
  '../../iBridge360_converted/ibridge360.com/institution-weekly-and-monthly-programs/index.html',
);
...
const SECTIONS = [
  {
    id: '306a8d61',
    name: 'InstitutionWeeklyMonthlyHeroSection',
    file: 'components/sections/institution-weekly-and-monthly-programs/InstitutionWeeklyMonthlyHeroSection.jsx',
  },
  {
    id: '8522b38',
    name: 'InstitutionWeeklyMonthlyMainSection',
    file: 'components/sections/institution-weekly-and-monthly-programs/InstitutionWeeklyMonthlyMainSection.jsx',
  },
];
...
const pageStart = html.indexOf('class="elementor elementor-19959"');
...
write(
  'pages/InstitutionWeeklyAndMonthlyPrograms/InstitutionWeeklyAndMonthlyPrograms.jsx',
...
function InstitutionWeeklyAndMonthlyPrograms() {
  ...
  return (
    <>
      <Helmet>
        <title>Weekly and Monthly Programs - iBridge360</title>
        <meta
          name="description"
          content="Weekly and monthly engagements for institutions — flexible bootcamps integrated into your schedule, NAAC ready by design."
        />
      </Helmet>
...
console.log('Institution Weekly and Monthly Programs page generation complete.');
