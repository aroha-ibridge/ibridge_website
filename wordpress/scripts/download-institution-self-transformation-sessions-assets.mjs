...
const html = fs.readFileSync(
  path.join(mirrorRoot, 'institution-self-transformation-sessions-for-students-and-faculty/index.html'),
  'utf8',
);
...
const cssPath = 'wp-content/uploads/elementor/css/post-194349f99.css';
paths.add(cssPath);
