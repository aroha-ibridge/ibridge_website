...
const sourceHtml = path.resolve(
  root,
  '../../iBridge360_converted/ibridge360.com/institution-epbl/index.html',
);
...
const SECTIONS = [
  {
    id: '306a8d61',
    name: 'InstitutionEpblHeroSection',
    file: 'components/sections/institution-epbl/InstitutionEpblHeroSection.jsx',
  },
  {
    id: '8522b38',
    name: 'InstitutionEpblMainSection',
    file: 'components/sections/institution-epbl/InstitutionEpblMainSection.jsx',
  },
];
...
const pageStart = html.indexOf('class="elementor elementor-18547"');
...
write(
  'pages/InstitutionEpbl/InstitutionEpbl.jsx',
...
function InstitutionEpbl() {
  ...
  return (
    <>
      <Helmet>
        <title>EPBL by IBridge360 - iBridge360</title>
        <meta
          name="description"
          content="Experiential Project-Based Learning (EPBL) by iBridge360 — hands-on learning that bridges classroom theory with real-world industry projects."
        />
      </Helmet>
...
console.log('Institution EPBL page generation complete.');
