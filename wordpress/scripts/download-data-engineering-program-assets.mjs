...
const html = fs.readFileSync(path.join(mirrorRoot, 'data-engineering-program/index.html'), 'utf8');
...
console.log(
  `Data Engineering Program assets: ${ok} downloaded, ${mirror} from mirror, ${skip} skipped, ${fail} failed (${list.length} unique paths)`,
);
