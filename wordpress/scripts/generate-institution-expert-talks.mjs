...
const sourceHtml = path.resolve(
  root,
  '../../iBridge360_converted/ibridge360.com/institution-expert-talks/index.html',
);
...
const SECTIONS = [
  {
    id: '306a8d61',
    name: 'InstitutionExpertTalksHeroSection',
    file: 'components/sections/institution-expert-talks/InstitutionExpertTalksHeroSection.jsx',
  },
  {
    id: '8522b38',
    name: 'InstitutionExpertTalksMainSection',
    file: 'components/sections/institution-expert-talks/InstitutionExpertTalksMainSection.jsx',
  },
];
...
const pageStart = html.indexOf('class="elementor elementor-19095"');
...
write(
  'pages/InstitutionExpertTalks/InstitutionExpertTalks.jsx',
...
function InstitutionExpertTalks() {
  ...
  return (
    <>
      <Helmet>
        <title>Expert Talks by IBridge360 - iBridge360</title>
        <meta
          name="description"
          content="Inspiring students and elevating institutions with expert talks aligned to NAAC excellence criteria."
        />
      </Helmet>
...
console.log('Institution Expert Talks page generation complete.');
