...
const sourceHtml = path.resolve(
  root,
  '../../iBridge360_converted/ibridge360.com/institution-online-offline-programs/index.html',
);
...
const SECTIONS = [
  {
    id: '306a8d61',
    name: 'InstitutionOnlineOfflineHeroSection',
    file: 'components/sections/institution-online-offline-programs/InstitutionOnlineOfflineHeroSection.jsx',
  },
  {
    id: '8522b38',
    name: 'InstitutionOnlineOfflineMainSection',
    file: 'components/sections/institution-online-offline-programs/InstitutionOnlineOfflineMainSection.jsx',
  },
];
...
const pageStart = html.indexOf('class="elementor elementor-19659"');
...
write(
  'pages/InstitutionOnlineOfflinePrograms/InstitutionOnlineOfflinePrograms.jsx',
...
function InstitutionOnlineOfflinePrograms() {
  ...
  return (
    <>
      <Helmet>
        <title>Online & Offline Programs - iBridge360</title>
        <meta
          name="description"
          content="Online and offline programs offered by iBridge360 — from leadership development to technical training for institutions."
        />
      </Helmet>
...
console.log('Institution Online Offline Programs page generation complete.');
