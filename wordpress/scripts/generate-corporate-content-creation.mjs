...
const sourceHtml = path.resolve(
  root,
  '../../iBridge360_converted/ibridge360.com/corporate-content-creation/index.html',
);
...
const SECTIONS = [
  {
    id: '306a8d61',
    name: 'CorporateContentCreationHeroSection',
    file: 'components/sections/corporate-content-creation/CorporateContentCreationHeroSection.jsx',
  },
  {
    id: '8522b38',
    name: 'CorporateContentCreationMainSection',
    file: 'components/sections/corporate-content-creation/CorporateContentCreationMainSection.jsx',
  },
];
...
const pageStart = html.indexOf('class="elementor elementor-20237"');
...
write(
  'pages/CorporateContentCreation/CorporateContentCreation.jsx',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Tailored content creation services to boost your brand's online presence, engage your audience, and drive business growth."
        />
      </Helmet>
...
console.log('Corporate Content Creation page generation complete.');
