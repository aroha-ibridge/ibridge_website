...
const sourceHtml = path.resolve(
  root,
  '../../iBridge360_converted/ibridge360.com/institution-experiential-learning-platform/index.html',
);
...
const SECTIONS = [
  {
    id: '306a8d61',
    name: 'InstitutionElpaasHeroSection',
    file: 'components/sections/institution-experiential-learning-platform/InstitutionElpaasHeroSection.jsx',
  },
  {
    id: '8522b38',
    name: 'InstitutionElpaasMainSection',
    file: 'components/sections/institution-experiential-learning-platform/InstitutionElpaasMainSection.jsx',
  },
];
...
const pageStart = html.indexOf('class="elementor elementor-19651"');
...
write(
  'pages/InstitutionExperientialLearningPlatform/InstitutionExperientialLearningPlatform.jsx',
...
function InstitutionExperientialLearningPlatform() {
  ...
  return (
    <>
      <Helmet>
        <title>Experiential Learning Platform (ELPaaS) - iBridge360</title>
        <meta
          name="description"
          content="Experiential Learning Platform as a Service (ELPaaS) — track hands-on projects, internships, and industry projects with digital portfolios."
        />
      </Helmet>
...
console.log('Institution Experiential Learning Platform page generation complete.');
