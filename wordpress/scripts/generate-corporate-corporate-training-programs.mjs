...
const sourceHtml = path.resolve(
  root,
  '../../iBridge360_converted/ibridge360.com/corporate-corporate-training-programs/index.html',
);
...
const SECTIONS = [
  {
    id: '306a8d61',
    name: 'CorporateTrainingHeroSection',
    file: 'components/sections/corporate-corporate-training-programs/CorporateTrainingHeroSection.jsx',
  },
  {
    id: '8522b38',
    name: 'CorporateTrainingMainSection',
    file: 'components/sections/corporate-corporate-training-programs/CorporateTrainingMainSection.jsx',
  },
];
...
const pageStart = html.indexOf('class="elementor elementor-20298"');
...
write(
  'pages/CorporateCorporateTrainingPrograms/CorporateCorporateTrainingPrograms.jsx',
  `import { Helmet } from 'react-helmet-async';
import useCorporateTrainingScrollPanels from '../../hooks/useCorporateTrainingScrollPanels';
${imports}

function CorporateCorporateTrainingPrograms() {
  useCorporateTrainingScrollPanels();

  return (
    <>
      <Helmet>
        <title>Corporate Training Programs - iBridge360</title>
        <meta
          name="description"
          content="iBridge360 delivers customized corporate training programs to empower teams with the skills and insights needed to excel in dynamic workplaces."
        />
      </Helmet>
      <div data-elementor-type="wp-page" data-elementor-id="20298" className="elementor elementor-20298" data-elementor-post-type="page">
${sectionsRender}
      </div>
    </>
  );
...
export default CorporateCorporateTrainingPrograms;
`,
);

console.log('Corporate Corporate Training Programs page generation complete.');
