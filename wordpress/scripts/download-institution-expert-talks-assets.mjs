...
const html = fs.readFileSync(path.join(mirrorRoot, 'institution-expert-talks/index.html'), 'utf8');
...
const cssPath = 'wp-content/uploads/elementor/css/post-19095aee4.css';
paths.add(cssPath);
