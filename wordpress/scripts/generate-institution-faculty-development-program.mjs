...
const sourceHtml = path.resolve(
  root,
  '../../iBridge360_converted/ibridge360.com/institution-faculty-development-program/index.html',
);
...
const SECTIONS = [
  {
    id: '306a8d61',
    name: 'InstitutionFdpHeroSection',
    file: 'components/sections/institution-faculty-development-program/InstitutionFdpHeroSection.jsx',
  },
  {
    id: '8522b38',
    name: 'InstitutionFdpMainSection',
    file: 'components/sections/institution-faculty-development-program/InstitutionFdpMainSection.jsx',
  },
];
...
const pageStart = html.indexOf('class="elementor elementor-19356"');
...
write(
  'pages/InstitutionFacultyDevelopmentProgram/InstitutionFacultyDevelopmentProgram.jsx',
...
function InstitutionFacultyDevelopmentProgram() {
  ...
  return (
    <>
      <Helmet>
        <title>Faculty Development Program - iBridge360</title>
        <meta
          name="description"
          content="Educator Evolution Program by iBridge360 — elevating academic quality to drive rankings and meet NAAC benchmarks."
        />
      </Helmet>
...
console.log('Institution Faculty Development Program page generation complete.');
