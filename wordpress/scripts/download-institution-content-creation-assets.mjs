...
const html = fs.readFileSync(path.join(mirrorRoot, 'institution-content-creation/index.html'), 'utf8');
...
const cssPath = 'wp-content/uploads/elementor/css/post-19824b811.css';
paths.add(cssPath);
