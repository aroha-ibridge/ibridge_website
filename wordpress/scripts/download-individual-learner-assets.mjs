...
const html = fs.readFileSync(
  path.resolve(__dirname, '../../../iBridge360_converted/ibridge360.com/individual-learner/index.html'),
  'utf8',
);
...
const cssFiles = ['wp-content/uploads/elementor/css/post-3348f2.css'];
...
console.log(
  `Individual Learner assets: ${ok} downloaded, ${mirror} from mirror, ${skip} skipped, ${fail} failed (${list.length} unique paths)`,
);
