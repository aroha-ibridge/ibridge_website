...
const sourceHtml = path.resolve(
  root,
  '../../iBridge360_converted/ibridge360.com/institution-soft-skills-for-college-students/index.html',
);
...
const SECTIONS = [
  {
    id: '306a8d61',
    name: 'InstitutionSoftSkillsHeroSection',
    file: 'components/sections/institution-soft-skills-for-college-students/InstitutionSoftSkillsHeroSection.jsx',
  },
  {
    id: '8522b38',
    name: 'InstitutionSoftSkillsMainSection',
    file: 'components/sections/institution-soft-skills-for-college-students/InstitutionSoftSkillsMainSection.jsx',
  },
];
...
const pageStart = html.indexOf('class="elementor elementor-19905"');
...
write(
  'pages/InstitutionSoftSkillsForCollegeStudents/InstitutionSoftSkillsForCollegeStudents.jsx',
...
function InstitutionSoftSkillsForCollegeStudents() {
  ...
  return (
    <>
      <Helmet>
        <title>Soft Skills for College Students - iBridge360</title>
        <meta
          name="description"
          content="iBridge360 soft skills programs help college students build learner-centric experiences aligned with OBE standards and accreditation success."
        />
      </Helmet>
...
console.log('Institution Soft Skills page generation complete.');
