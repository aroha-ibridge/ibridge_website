...
const html = fs.readFileSync(path.join(mirrorRoot, 'privacy-policy/index.html'), 'utf8');
...
console.log(
  `Privacy Policy assets: ${ok} downloaded, ${mirror} from mirror, ${skip} skipped, ${fail} failed (${list.length} unique paths)`,
);
