...
const mirrorRoot = path.resolve(
  __dirname,
  '../../../iBridge360_converted/ibridge360.com',
);
const html = fs.readFileSync(
  path.join(mirrorRoot, 'full-stack-development-mern-program-2/index.html'),
  'utf8',
);
...
console.log(
  `Full Stack MERN Program assets: ${ok} downloaded, ${mirror} from mirror, ${skip} skipped, ${fail} failed (${list.length} unique paths)`,
);
