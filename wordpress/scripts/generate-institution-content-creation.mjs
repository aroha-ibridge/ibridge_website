...
const sourceHtml = path.resolve(
  root,
  '../../iBridge360_converted/ibridge360.com/institution-content-creation/index.html',
);
...
const SECTIONS = [
  {
    id: '306a8d61',
    name: 'InstitutionContentCreationHeroSection',
    file: 'components/sections/institution-content-creation/InstitutionContentCreationHeroSection.jsx',
  },
  {
    id: '8522b38',
    name: 'InstitutionContentCreationMainSection',
    file: 'components/sections/institution-content-creation/InstitutionContentCreationMainSection.jsx',
  },
];
...
const pageStart = html.indexOf('class="elementor elementor-19824"');
...
write(
  'pages/InstitutionContentCreation/InstitutionContentCreation.jsx',
...
function InstitutionContentCreation() {
  ...
  return (
    <>
      <Helmet>
        <title>Content Creation Services - iBridge360</title>
        <meta
          name="description"
          content="Custom content creation services for institutions — high-quality content that builds your online presence and resonates with your audience."
        />
      </Helmet>
...
console.log('Institution Content Creation page generation complete.');
